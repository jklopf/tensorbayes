...
Ew = tf.Variable(1.0, dtype=tf.float32)
...
s0E = tf.constant(0.001, dtype=tf.float32)
s0B = tf.constant(0.001, dtype=tf.float32)
...
dash = '-' * 40
print(dash)
print('{:<10s}{:>7s}{:>9s}{:>4s}'.format('s2e', 's2b     ','corr(eb,bt)', 'PiP'))
print(dash)
print(results)
