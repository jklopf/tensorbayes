...
for i in tqdm(range(num_iter)):
    ...
    # Store sampling logs      
    sigma_e_log.append(deepcopy(sigma2_e))
    sigma_b_log.append(sigma2_b)
    ny_log.append(deepcopy(ny))
    beta_log.append(deepcopy(Ebeta))
...
print(dash)
print('{:<10s}{:>4s}{:>12s}'.format('Computed betas','# marker in model','True betas'))
print(dash)
for i in range(M):
